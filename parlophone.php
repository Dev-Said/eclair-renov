    ...
    <section class="bg-white py-32 px-6 lg:px-8">
        <div class="mx-auto max-w-3xl text-base leading-7 text-gray-700">
            ...
            <div class="p-10 my-10 w-full text-left bg-gradient-to-r from-[#dbeefd] to-[#8ba9c2]">
                ...
                <p class="mt-6 max-w-xl text-lg leading-7 text-gray-600">
                ...
                <div class="mt-10 flex flex-col md:flex-row items-start justify-start md:items-center md:justify-start space-y-4 md:space-y-0 md:space-x-4">
                    ...
                    <a href="mailto:eclairenov@gmail.com" class="rounded-md bg-[#206296] w-64 md:w-auto h-14 px-5 text-lg font-semibold text-white shadow-sm hover:bg-[#407aa5] focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-[#206296] flex justify-center items-center">
