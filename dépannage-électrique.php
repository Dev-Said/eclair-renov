<?php
$title = "Dépannage électrique d'urgence 1060 Saint-Gilles";
        ...
        <section class="w-full py-20 bg-gray-800 text-gray-200 text-lg flex justify-center items-center">
            <div class="flex items-start">
                ...
                <p class="w-2xl md:w-6xl md:max-w-6xl text-left">
                    D’Uccle à Saint-Gilles en passant par Ixelles et Forest, nous intervenons partout à Bruxelles ainsi qu’aux alentours, dans le Brabant wallon et le Brabant flamand. Tant chez les particuliers que les professionnels.
                </p>
            </div>
        </section>
