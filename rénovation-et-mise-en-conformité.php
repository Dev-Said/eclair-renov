...
<div class='w-full h-full min-h-[100vh] mt-24 flex flex-col justify-start items-center'>
    ...
    <section class="w-full bg-white py-24 sm:py-32">
        <div class="mx-auto max-w-7xl px-6 pb-32 lg:px-8 border-b-2 border-gray-200">
            <div class="mx-auto grid max-w-2xl grid-cols-1 items-start gap-y-16 gap-x-8 sm:gap-y-24 lg:mx-0 lg:max-w-7xl lg:grid-cols-2">
                <div class="lg:pr-4">
                    <div class="relative overflow-hidden rounded-3xl bg-gray-900 px-6 pb-9 pt-64 shadow-2xl sm:px-12 lg:max-w-lg lg:px-8 lg:pb-8 xl:px-10 xl:pb-10"> <img class="absolute inset-0 h-full w-full object-cover brightness-125 saturate-0" src="https://images.unsplash.com/photo-1630569267625-157f8f9d1a7e?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=2669&q=80" alt="">
                        <div class="absolute inset-0 bg-gray-900 mix-blend-multiply"></div> <svg viewBox="0 0 1097 845" aria-hidden="true" class="absolute top-1/2 left-1/2 -ml-16 w-[68.5625rem] -translate-x-1/2 -translate-y-1/2 transform-gpu blur-3xl">
                        ...
                        <figure class="relative isolate"> <svg viewBox="0 0 162 128" fill="none" aria-hidden="true" class="absolute -top-4 -left-2 -z-10 h-32 stroke-white/20">
                            ...
                            </svg> <img src="https://tailwindui.com/img/logos/workcation-logo-white.svg" alt="" class="h-12 w-auto">
                    ...
                    <div class="max-w-xl">
                        ...
                        <ul class="mt-3 space-y-4">
                            <li class="leading-6 text-base font-semibold text-gray-900 flex justify-start items-start">
                                ...
                                Audit des installations électriques existantes
                            </li>
                            <li class="leading-6 text-base font-semibold text-gray-900 flex justify-start items-start">
                                <span class="h-8 min-h-[32px] w-8 min-w-[32px] mr-3 border-2 border-green-700 rounded-full flex justify-center items-center">
                                    <img src="/images/check-lg.svg" class="h-5">
                                </span>
                                Entretien des tableaux électriques
                            </li>
                            <li class="leading-6 text-base font-semibold text-gray-900 flex justify-start items-start">
                                <span class="h-8 min-h-[32px] w-8 min-w-[32px] mr-3 border-2 border-green-700 rounded-full flex justify-center items-center">
                                    <img src="/images/check-lg.svg" class="h-5">
                                </span>
                                Renforcement des compteurs électriques
                            </li>
                            <li class="leading-6 text-base font-semibold text-gray-900 flex justify-start items-start">
                                <span class="h-8 min-h-[32px] w-8 min-w-[32px] mr-3 border-2 border-green-700 rounded-full flex justify-center items-center">
                                    <img src="/images/check-lg.svg" class="h-5">
                                </span>
                                Optimisation des éclairages (suspensions, rails, luminaires encastrés...)
                            </li>
                            <li class="leading-6 text-base font-semibold text-gray-900 flex justify-start items-start">
                                <span class="h-8 min-h-[32px] w-8 min-w-[32px] mr-3 border-2 border-green-700 rounded-full flex justify-center items-center">
                                    <img src="/images/check-lg.svg" class="h-5">
                                </span>
                                Maintenance et remplacement des fusibles, des câbles, des prises, des fils...
                            </li>
                            <li class="leading-6 text-base font-semibold text-gray-900 flex justify-start items-start">
                                <span class="h-8 min-h-[32px] w-8 min-w-[32px] mr-3 border-2 border-green-700 rounded-full flex justify-center items-center">
                                    <img src="/images/check-lg.svg" class="h-5">
                                </span>
                                Montage de système électrique dans une pièce spécifique (dépendance, cuisine...)
                            </li>
                        </ul>
                    </div>
    ...
    <section class="w-full py-20 bg-gray-800 text-gray-200 text-lg flex justify-center items-center">
        <div class="flex items-start">
            <img src="/images/patch-check.svg" class="h-8 mr-3">
